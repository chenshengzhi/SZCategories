...
+ (UIImage *)sz_imageWithColor:(UIColor *)color
                          size:(CGSize)size {
    return [UIImage sz_imageWithColor:color
                                 size:size
                         cornerRadius:0];
}
...
+ (UIImage *)sz_imageWithColor:(UIColor *)color
    ...
    UIBezierPath *borderPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, size.width, size.height)
                                                          cornerRadius:cornerRadius];
    [borderColor setFill];
    [borderPath fill];

    UIBezierPath *mainPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(borderWidth,
                                                                                borderWidth,
...
- (UIImage *)sz_croppedImageWithRect:(CGRect)rect {
    CGRect scaleRect = CGRectMake(self.scale*rect.origin.x,
                                  self.scale*rect.origin.y,
                                  self.scale*rect.size.width,
                                  self.scale*rect.size.height);
