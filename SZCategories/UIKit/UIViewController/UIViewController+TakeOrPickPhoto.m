//
//  UIViewController+TakeOrPickPhoto.m
//  SZCategories
//
...
@implementation UIViewController (TakeOrPickPhoto)
 ...
 */
- (void)pickAnPhotoWithAllowEditing:(BOOL)allowsEditing
 ...
 *  @param successBlock  回调
 */
- (void)takeAnPhotoWithAllowEditing:(BOOL)allowsEditing
                         sourceView:(UIView *)sourceView
                            success:(PAImagePickerSuccessBlock)successBlock {
